...
namespace Foundation.Infrastructure.Routing
{
    [InitializableModule]
    [ModuleDependency(typeof(EPiServer.Web.InitializationModule))]
    public class MarketRouteInitialization : IInitializableModule
    {
        ...
        private void Events_OnGeneratedUrl(object sender, UrlGeneratorEventArgs e)
        {
            ...
            var market = _currentMarket.GetCurrentMarket()?.MarketId.ToString().ToLower();
